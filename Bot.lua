...
local DogPics = {
    ...
    {"MegaAussies9, CC BY-SA 3.0\nhttp://creativecommons.org/licenses/by-sa/3.0/, via Wikimedia Commons", "https://commons.wikimedia.org/wiki/File:Able_12_weeks_with_max_078.jpg"}
...
if Message.author.bot == false and Message.content == "random dog" then
